...
golem::add_module(name = "simple", with_test = TRUE, module_template = brochure::new_page) # Name of the module
golem::add_module(name = "one", with_test = TRUE, module_template = brochure::new_page) # Name of the module
...
usethis::use_data_raw(name = "race", open = FALSE)
